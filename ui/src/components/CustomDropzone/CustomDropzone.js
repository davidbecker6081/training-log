...
const CustomDropzone = () => {
    ...
    const onDrop = (0, react_1.useCallback)((acceptedFiles) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield (0, csv_parser_1.parseCsv)({ csvFile: acceptedFiles[0], callbackFn: onDropCallback });
        }
        catch (error) {
    ...
    return (react_1.default.createElement("div", Object.assign({}, getRootProps()),
        ...
        react_1.default.createElement("p", { className: "is-flex is-align-items-center" },
            "Upload Peak Force",
            react_1.default.createElement(tfi_1.TfiImport, { className: "mar-l" }))));
};
